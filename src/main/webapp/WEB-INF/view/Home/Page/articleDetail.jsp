...
<rapid:override name="header-style">
    <rapid:override name="header-style">
<%--<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/ueditor/third-party/ir-black.css">--%>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.min.js"></script>
<%--<script type="text/javascript" src="${pageContext.request.contextPath}/ueditor/third-party/highlight.pack.js"></script>--%>
<%--<script type="text/javascript">--%>
    <%--$(function() {--%>
        ...
        <%--layui.code({--%>
            <%--elem: 'code',//默认值为.layui-code--%>
            <%--title: '代码',//默认值为.layui-code--%>
            <%--// skin: 'notepad', //如果要默认风格，不用设定该key。--%>
            <%--about: false--%>
        <%--});--%>
        <%--$('.layui-code-h3').replaceWith('');--%>
    <%--});--%>
<%--</script>--%>
...
<%--<link rel="stylesheet" href="/css/highlight.css">--%>
 ...
 <script type="text/javascript" src="${pageContext.request.contextPath}/ueditor/third-party/SyntaxHighlighter/shBrushJava.js"></script>
 <script type="text/javascript" src="${pageContext.request.contextPath}/ueditor/third-party/SyntaxHighlighter/shBrushXml.js"></script>
 <script type="text/javascript" src="${pageContext.request.contextPath}/ueditor/third-party/SyntaxHighlighter/shAutoloader.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/ueditor/third-party/SyntaxHighlighter/shCoreRDark.css">
<script type="text/javascript">
    $(function() {
